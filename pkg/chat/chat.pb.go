...
func (x *SendChatRequest) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *SendChatRequest) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
var file_chat_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x32, 0xc7, 0x01, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x74, 0x41, 0x50, 0x49, 0x12,
	...
	0x12, 0x3d, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x68, 0x61, 0x74, 0x12, 0x17,
	...
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2c, 0x5a,
	0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x49, 0x52, 0x58, 0x43,
	0x49, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x6b,
	0x67, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_chat_proto_goTypes = []interface{}{
	...
	(*SendChatRequest)(nil),       // 3: chat.SendChatRequest
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 5: google.protobuf.Empty
}
var file_chat_proto_depIdxs = []int32{
	4, // 0: chat.SendChatRequest.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: chat.ChatAPI.CreateChat:input_type -> chat.CreateChatRequest
	2, // 2: chat.ChatAPI.DeleteChat:input_type -> chat.DeleteChatRequest
	3, // 3: chat.ChatAPI.SendMessage:input_type -> chat.SendChatRequest
	1, // 4: chat.ChatAPI.CreateChat:output_type -> chat.CreateChatResponse
	5, // 5: chat.ChatAPI.DeleteChat:output_type -> google.protobuf.Empty
	5, // 6: chat.ChatAPI.SendMessage:output_type -> google.protobuf.Empty
